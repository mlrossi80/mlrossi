	...
	<div class="row">
		...
		<div class="visible-xs-block col-xs-12">
			<div class="row">
				...
				<div class="col-xs-12">
					<h2><p class="lead" style="margin-top:-25px; margin-bottom:-50px">Curriculum Vitae</p></h2>
				</div>
	...
	<div class="row">
		<div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
			...
			<dl>
				...
				<dd></dd>
				<dd>Regular contributor at Microcosmos, a multimedia blog of microbiology: https://microcosmos.foldscope.com/?author=739/</dd>
				...
				<dd>Composition I and II</dd>
				<dd>Texts and Contexts: The Short Story</dd>
				<dd>Texts and Contexts: Art of the Graphic Novel</dd>
				<dd>Introduction to Literature </dd>
				<dd>Creative Writing Workshop</dd>
